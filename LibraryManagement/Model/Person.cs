namespace LibraryManagement.Model
{
    ...
    internal abstract class Person
    {
        ...
        public Person(string id, string role,string name, int age, string gender, DateTime dateofbirth, string address, string phonenumber, string email, string username, string password)
        {
            this.id = id;
            this.role = role;
            this.name = name;
